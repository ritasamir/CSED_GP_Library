...
<div class="post">
    ...
    <div class="entry" style="display: inline-block;">
            ...
            <p class="links"><a href="{{$post->doc_url}}"target="_blank" rel="noopener noreferrer" class="button">Read Full Document</a>
                &nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;<a href="/comments/{{$post->id}}" class="button">Comments</a></p>
    </div>
    <p>
