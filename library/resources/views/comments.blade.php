...
<div>
<a href="/posts/{{$post->id}}" style="float:left;"><i class="fa fa-arrow-left"style="font-size:30px;padding-right:8px;"></i></a>
...
<div class="container" style="padding:10px;">	
	<div class="card">
	    <div class="card-body">
	        <div class="row">
        	    <div class="col-md-2">
                    <img src="/images/avatars/{{$comment->user->avatar}}" class="img img-rounded img-fluid" 
...
<!-- <div class="post"> 
    <div class="entry" style="display: inline-block;">
        <ul>
            <li>
                <a href="#" style="font-size: 18px;padding-left:5px;">
                    <img src="/images/avatars/{{$comment->user->avatar}}" style="width:30px; height:30px; float:left; border-radius:50%;align:middle;  ">
